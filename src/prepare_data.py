...
def main(dataset_name: str,data_save_dir: str):
    data_file  = f"{dataset_name}.json"
    data_save = os.path.join(data_save_dir, data_file)
    
    zip_file  = f"{dataset_name}_videos.zip"
    video_dir = os.path.join(data_save_dir, "videos")
    zip_save = os.path.join(data_save_dir, zip_file)
...
if __name__ == "__main__":
    ...
    main(args.dataset_name,args.data_save_dir)